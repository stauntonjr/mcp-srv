 ...
 * MCP Message types
 */
export type MCPMessageType = 'initialize' | 'tools/list' | 'resources/list' | 'tools/call' | 'resources/read' | 'prompts/list' | 'prompts/get' | 'ping' | 'error' | 'notifications/initialized' | 'notifications/cancelled' | 'tools/list_changed' | 'resources/list_changed';
/**
